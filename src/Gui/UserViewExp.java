...
public class UserViewExp extends javax.swing.JFrame {
    static FundraiserManager fm=new FundraiserManager();
    static Donor donor;
    static Donation donation;
    public UserViewExp(FundraiserManager fm,Donor donor,Donation donation) {
        initComponents();
        ...
        String list=fm.expiredCompaigns();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("D I S P L  A Y I N G   A L L   E X P I  R E D   C O M P A I G N S");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserViewExp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserViewExp(fm,donor,donation).setVisible(true);
            }
        });
    }
